...
export interface PageShellProps {
  ...
  width?: 'narrow' | 'wide';
  /** Right-hand footer note: the spectral range on Home, the job id on a result. */
...
export default function PageShell({
  ...
  return (
    <>
      ...
      <main className={cn('mx-auto px-6', maxWidth, className)}>{children}</main>
      <footer
        className={cn(
      ...
      >
        <span>SpectraCalc — Спектроскопия комбинационного рассеяния онлайн</span>
